...
/* --- SS_Fuel_Run10ms: ignition off --- */
/* Covers reset behavior requirements */
...
/* --- SS_Fuel_Run10ms: ignition on + autostop off --- */
...
/* --- SS_Fuel_Run10ms: ignition on + autostop on --- */
...
/* --- fuel saved remains zero while ignition on + autostop off --- */
