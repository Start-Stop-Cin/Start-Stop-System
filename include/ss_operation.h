...
typedef struct
{
    ...
    bool ButtonInput;    // Start-stop button input (true if pressed, false if not pressed)  
...
void print_inputs_outputs ( const SsOperationInputs_t *inputs, SsOperationOutputs_t *outputs ); // Helper function to print the current inputs and outputs for debugging purposes
